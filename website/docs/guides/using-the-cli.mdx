...
The metadata CLI turns a folder of raw jsPsych data into a [Psych-DS](https://psychds-docs.readthedocs.io/en/latest/) compliant project. Prefer point-and-click? Use the **[web wizard](/)** instead — it does the same thing in your browser (see [Using the wizard](./using-the-wizard.mdx)).
