...
**Warnings** never make validation fail. They point at recommended metadata you haven't filled in — an optional field, a suggested folder — so treat them as a checklist rather than a problem.
